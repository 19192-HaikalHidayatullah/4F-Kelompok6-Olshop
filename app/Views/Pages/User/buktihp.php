	...
	<header class="container-fluid">
		<div class="row">
			<div class="col-12 text-left py-1">
				<p><a class="btn" href="/user/hp"><img src="/img/back.png"></a> Bukti Pembayaran</p>
			</div>
		</div>
	</header>
	<div class="row">
			...
			<div class="content">
				<table class="abu2">
					<tbody>
						...
						?>
						<td class="gambar"><img style="width: 200px;" src="/img/admin/<?= $hp['Gambar']; ?>"></td>
						<td class="nama2">
							<p1><b><?= $hp['Nama_Hp']; ?></b></p1><br>
							<p2><?= $Harga_Format; ?></p2><br>
							<p3>Metode Pembayaran : DANA (0856123456)</p3>
						</td>
						<form action="/user/kirimbuktihp/<?= $hp['Id_Hp']; ?>" method="post" enctype="multipart/form-data">
